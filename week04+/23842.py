...
result = ["impossible" for _ in range(51)]
                ...
                for e in range(10):
                    for f in range(10):
                        if (a+c)*10 + b + d == e*10+f:
                            if result[nums[a]+nums[b]+nums[c]+nums[d]+nums[e]+nums[f]+4] != "impossible" :continue
                            result[nums[a]+nums[b]+nums[c]+nums[d]+nums[e]+nums[f]+4] = f"{a}{b}+{c}{d}={e}{f}"
